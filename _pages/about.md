...
기획, 개발 둘 다 재밌어서 끊임없이 고민하다가.. 개발자가 되기로 결심한 해입니다. 데이터로 최종적으로 사람들에게 행복을 줄 수 있는 Data Scientist / ML Engineer가 되야겠다고 다짐했습니다. 머신러닝, 데이터 엔지니어링, 데이터 분석 등을 공부하며 처음으로 논문을 내보고, 빅콘에서 최우수상🏆을 수상하는 등 나름 얻은게 많은 해입니다.

### 2019
>**Studied software engineering**  
본격적으로 개발을 공부하기 시작한 해입니다. 코딩의 코도 모르던 문과생이 파이썬의 매력에 빠져.. 파이썬 기반 프레임워크 위주로 공부했습니다. 그러던 중 머신러닝/딥러닝 분야에 관심을 갖게 되었습니다.
